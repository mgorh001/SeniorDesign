...
#define SYS_L293D_IN1_PIN	PIND4
#define SYS_L293D_IN2_PIN	PIND5
#define SYS_L293D_EN1_PIN	PIND6

// L293D H Bridge 1 Ports
#define SYS_L293D_IN1_PORT	PORTD
#define SYS_L293D_IN1_DIR	DDRD
#define SYS_L293D_IN2_PORT	PORTD
#define SYS_L293D_IN2_DIR	DDRD
...
#if (SYS_UM1)
// UM1 Pins
#define SYS_UM1_TRIG_PIN	PIND7
#define SYS_UM1_ECHO_PIN 	PINB0
// UM1 Ports
#define SYS_UM1_TRIG_PORT	PORTD
#define SYS_UM1_TRIG_DIR	DDRD
#define SYS_UM1_ECHO_PORT	PORTB
#define SYS_UM1_ECHO_DIR	DDRB
#endif // (SYS_UM1)

#if (SYS_UM2)
// UM2 Pins
#define SYS_UM2_TRIG_PIN	PINB1
#define SYS_UM2_ECHO_PIN	PINB0
// UM2 Ports
#define SYS_UM2_TRIG_PORT	PORTB
#define SYS_UM2_TRIG_DIR	DDRB
#define SYS_UM2_ECHO_PORT	PORTB
#define SYS_UM2_ECHO_DIR	DDRB
#endif // (SYS_UM2)
